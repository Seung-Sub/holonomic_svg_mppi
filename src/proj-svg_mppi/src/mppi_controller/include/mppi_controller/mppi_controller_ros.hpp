...
#include <geometry_msgs/Twist.h>   // 수정
...
namespace mppi {
    ...
    private:
        ...
        /* pub sub */
        ros::Subscriber sub_reference_path_;   //!< @brief reference path subscriber
        ros::Subscriber sub_current_goal_;     //!< @brief current goal subscriber
        ...
        ros::Publisher pub_twist_cmd_;    // 수정
        ...
        // bool is_reference_path_less_mode_ = false;
        bool is_reference_path_less_mode_ = false;
        ...
        geometry_msgs::Twist twist_msg_;  // 수정
        ...
        bool is_single_goal_ok_ = false;
        bool is_reference_path_ok_ = false;
        ...
        void visualize_local_costmap(const grid_map::GridMap& local_costmap);
        ...
        void callback_reference_path(const nav_msgs::Path& reference_path);

        void callback_current_goal(const geometry_msgs::PoseStamped& goal_msg);
